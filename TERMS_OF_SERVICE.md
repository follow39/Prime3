# Terms of Service for Prime3

**Last Updated: [INSERT_DATE]**

**⚠️ IMPORTANT: This is a template. Review and customize with legal counsel before publishing.**

---

## Acceptance of Terms

By downloading, installing, or using Prime3 ("the App"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, do not use the App.
...
We grant you a limited, non-exclusive, non-transferable, revocable license to use Prime3 for personal productivity purposes in accordance with these Terms.

### You May:
- Use the App for personal task management
- Install the App on devices you own or control
- Use all features included in your subscription tier (free or premium)

### You May Not:
- Reverse engineer, decompile, or disassemble the App
- Remove or modify any copyright or proprietary notices
- Use the App for any illegal or unauthorized purpose
- Share your premium subscription with others
- Attempt to gain unauthorized access to any part of the App
- Use the App in any way that could damage, disable, or impair the App

## User Accounts

Prime3 does NOT require user accounts. All data is stored locally on your device.

## Subscriptions and Payments (If Applicable)

### Free Version
Prime3 may offer a free version with basic features at no cost.

### Premium Features
Premium features may be available through:
- One-time purchase
...
### Changes to Pricing
We reserve the right to modify subscription pricing. Changes will not affect active subscriptions until renewal.

## User Content

### Your Goals and Tasks
- You retain all rights to your goals, tasks, and data
- Your data is stored locally on your device
- We do not claim any ownership of your content
- You are responsible for backing up your data

### Content Restrictions
You agree not to use Prime3 to create or store:
- Illegal content
...
You are responsible for backing up your data. Prime3 stores data locally on your device. We are not responsible for data loss due to:
...
### By Us
We may terminate or suspend your access to premium features if you violate these Terms.

## Age Requirements

Prime3 is suitable for ages 4+. Users under 13 should obtain parental consent before using the App.
...
By using Prime3, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service.
